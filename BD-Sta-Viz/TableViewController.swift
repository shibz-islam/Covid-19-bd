...
class TableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, SideMenuNavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = Constants.ViewControllerConstants.pageTitleRecentStat
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if self.isFiltering {
            ...
            switch segmentedControl.selectedSegmentIndex
            {
                ...
                case 1:
                    self.locationsForCity.count == 0 ? tableView.setEmptyView(title: Constants.ViewControllerConstants.pageNoDataMessageTitle, message: Constants.ViewControllerConstants.pageNoDataMessageSubTitle) : tableView.restore()
                    return self.locationsForCity.count
                default:
                    return 0
            }
        }
